...
class LifeCycle {
    ...
    async run(page) {
        ...
        const router = new Router(page, query, id_request, pages, configuration, id_engine, global.newser.socket); //запуск поиска и получение массива найденных новостей
