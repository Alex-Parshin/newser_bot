...
class News {
    ...
    constructor(page, pages, query, configuration, engine, id_request, socket = {}) {
        this.page = page;
        this.pages = pages;
        this.query = query;
    ...
    async getMainPage() {
        ...
        try {
            ...
            await utils.sleep(5000, 'Перед нажатием кнопки Enter')
    ...
    async getNews(selectors) {
        ...
        try {
            ...
            await utils.sleep(5000, 'Перед обработкой новостей')
