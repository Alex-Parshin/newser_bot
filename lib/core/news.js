...
export default class News {
    ...
    async getMainPage() {
        ...
        this.socket.emit('log', `На главной странице ${this.configuration.urls.startUrl}`)
