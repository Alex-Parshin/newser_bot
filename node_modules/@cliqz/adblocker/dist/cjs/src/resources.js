...
class Resources {
    ...
    getSerializedSize() {
        let estimatedSize = (data_view_1.sizeOfASCII(this.checksum) +
            (2 * data_view_1.sizeOfByte()) // resources.size
        );
        this.resources.forEach(({ contentType, body }, name) => {
            estimatedSize += (data_view_1.sizeOfASCII(name) +
                data_view_1.sizeOfASCII(contentType) +
                data_view_1.sizeOfASCII(body));
        });
