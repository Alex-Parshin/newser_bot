...
function createFuzzySignature(pattern) {
    tokens_buffer_1.TOKENS_BUFFER.reset();
    tokenizeNoSkipInPlace(pattern, tokens_buffer_1.TOKENS_BUFFER);
    return compact_set_1.compactTokens(new Uint32Array(tokens_buffer_1.TOKENS_BUFFER.slice()));
}
exports.createFuzzySignature = createFuzzySignature;
