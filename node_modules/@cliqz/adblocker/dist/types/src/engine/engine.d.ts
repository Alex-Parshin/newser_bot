...
export declare const ENGINE_VERSION = 249;
...
export default class FilterEngine extends EventEmitter<'csp-injected' | 'html-filtered' | 'request-blocked' | 'request-redirected' | 'request-whitelisted' | 'script-injected' | 'style-injected'> {
