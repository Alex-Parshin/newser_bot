...
import { bitCount, clearBit, createFuzzySignature, fastHash, fastStartsWith, fastStartsWithFrom, getBit, hasUnicode, isAlpha, isDigit, setBit, tokenizeInPlace, tokenizeRegexInPlace, tokenizeWithWildcardsInPlace, } from '../utils';
...
function computeFilterId(csp, mask, filter, hostname, domains, denyallow, redirect, fuzzy) {
...
export default class NetworkFilter {
            ...
            for (let i = 0; i < options.length; i += 1) {
                ...
                switch (option) {
                    ...
                    case 'first-party':
                        ...
                        break;
                    case 'fuzzy':
                        mask = setBit(mask, 65536 /* fuzzyMatch */);
                        break;
                    case 'redirect-rule':
                    case 'redirect':
    ...
    getIdWithoutBadFilter() {
        ...
        return computeFilterId(this.csp, this.mask & ~131072 /* isBadFilter */, this.isFuzzy() ? undefined : this.filter, this.hostname, this.domains, this.denyallow, this.redirect, this.isFuzzy() ? this.getFuzzySignature() : undefined);
    }
    getId() {
        if (this.id === undefined) {
            this.id = computeFilterId(this.csp, this.mask, this.isFuzzy() ? undefined : this.filter, this.hostname, this.domains, this.denyallow, this.redirect, this.isFuzzy() ? this.getFuzzySignature() : undefined);
        }
        return this.id;
    }
    hasFilter() {
    ...
    isFuzzy() {
        return getBit(this.mask, 65536 /* fuzzyMatch */);
    }
    isException() {
